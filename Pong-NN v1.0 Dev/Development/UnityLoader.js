...
(function() {
 var loadPackage = function(metadata) {
    ...
    var PACKAGE_NAME = 'Pong-NN v1.0 Dev.data';
    var REMOTE_PACKAGE_BASE = 'Pong-NN v1.0 Dev.data';
    ...
    var REMOTE_PACKAGE_NAME = typeof Module['locateFile'] === 'function' ?
      ...
      var REMOTE_PACKAGE_SIZE = 2844418;
      var PACKAGE_UUID = 'c1c7d797-88d8-408e-952d-e91e4fb9a6f2';
...
Module['FS_createPath']('/Managed/mono', '2.0', true, true);
    ...
    new DataRequest(22, 63829, 0, 0).open('GET', '/data.unity3d');
    new DataRequest(63829, 63848, 0, 0).open('GET', '/methods_pointedto_by_uievents.xml');
    new DataRequest(63848, 66861, 0, 0).open('GET', '/preserved_derived_types.xml');
    new DataRequest(66861, 1941821, 0, 0).open('GET', '/Il2CppData/Metadata/global-metadata.dat');
    new DataRequest(1941821, 2816793, 0, 0).open('GET', '/Resources/unity_default_resources');
    new DataRequest(2816793, 2844418, 0, 0).open('GET', '/Managed/mono/2.0/machine.config');
    ...
    function processPackageData(arrayBuffer) {
      ...
      DataRequest.prototype.byteArray = byteArray;
          ...
          Module['removeRunDependency']('datafile_Pong-NN v1.0 Dev.data');

    };
    Module['addRunDependency']('datafile_Pong-NN v1.0 Dev.data');
